  ...
  <div id="productList" class="mainWrap">
    ...
    <div class="dialog">
      ...
      <el-dialog title="提示" :visible.sync="checkVisible" width="50%">
        ...
        <div class="ly-flex ly-justify-sb" style="padding:20px">
          <span style="width:100px;line-height:54px">审核意见:</span>
          <el-input
            v-model="checkInfo"
            type="textarea"
        ...
        <span slot="footer" class="dialog-footer">
          <el-button
            type="danger"
            @click="handleClick('拒绝')"
            :loading="sumbitLoading"
            size="small"
          >拒绝</el-button>
          <el-button
            type="primary"
            @click="handleClick('通过')"
            :loading="sumbitLoading"
            size="small"
          >通过</el-button>
        </span>
        ...
        case '通过':
          {
            let obj = {
              id: this.editId,
              state: 1,
              reviewTheDetails: this.checkInfo
            }
