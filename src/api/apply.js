...
export function getApplyPageInfo(params) {
	return request({
		url: process.env.VUE_APP_WEB_MANAGE + '/application/page/info',
		method: 'get',
		params: params,
	})
}
...
export function companyTopWeight(params) {
	return request({
		url: process.env.VUE_APP_WEB_MANAGE + '/application/top/weight',
		method: 'post',
		params: params,
	})
}
...
export function addNewApply(params) {
	return request({
		url: process.env.VUE_APP_WEB_MANAGE + '/application/info',
		method: 'post',
		data: params,
	})
}
